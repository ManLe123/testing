...
if data_file is not None:
    ...
    number = st.number_input("Enter a number", min_value=0, max_value=5, key="unique_key1")
    ...
    number2 = st.number_input("Enter a number", min_value=1, max_value=5, key="unique_key2")
